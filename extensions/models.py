...
#from fairseq.models.transformer import base_architecture as _base_architecture
...
@register_model_architecture('transformer_domainmixing', 'transformer_domainmixing')
def transformer_domainmixing(args):
    base_architecture(args)

@register_model_architecture('transformer_domainweighting', 'transformer_domainweighting')
